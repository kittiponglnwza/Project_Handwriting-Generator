...
export function GridDebugOverlay({ glyphs }) {
  const stStyle = {
    ...
    excellent:  { border: "rgba(0,160,70,0.5)",   bg: "rgba(0,200,80,0.06)",   dot: "#00a046" },
    good:       { border: "rgba(0,160,70,0.5)",   bg: "rgba(0,200,80,0.06)",   dot: "#00a046" },
    acceptable: { border: "rgba(200,140,0,0.5)",  bg: "rgba(255,180,0,0.06)",  dot: "#c88c00" },
    poor:       { border: "rgba(200,140,0,0.5)",  bg: "rgba(255,180,0,0.06)",  dot: "#c88c00" },
    critical:   { border: "rgba(200,60,60,0.5)",  bg: "rgba(255,80,80,0.06)",  dot: "#c83c3c" },
    error:      { border: "rgba(200,60,60,0.5)",  bg: "rgba(255,80,80,0.06)",  dot: "#c83c3c" },
  }
